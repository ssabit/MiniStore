        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Attendance<a href="{{route('all.attendance')}}" class="btn btn-xs btn-info pull-right">All Attendance</a></h3>
                </div>
                                ...
                                <form action="{{url('/update-attendance')}}" method="post">
                                    ...
                                    @foreach($data as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="radio" name="attendance[{{$row->id}}]" value="Present" required <?php
